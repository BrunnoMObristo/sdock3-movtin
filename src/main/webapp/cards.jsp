...
<body>
    <div class="container">
        ...
        <!-- Início Cards -->
        <!-- IMPORTANTE: coloque ao menos três cards coloridos, um de cada cor. Altere a altura da div se precisar.  -->
        <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card-deck">
                            <div class="card text-white bg-primary mb-3">
                                <img class="card-img-top" src="img/pz_01_170x170.png" alt="Imagem de capa do card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><small class="text-white">Atualizados 3 minutos atrás</small></p>
                                </div>
                            </div>
                            <div class="card text-white bg-dark mb-3">
                                <img class="card-img-top" src="img/pz_02_170x170.png" alt="Imagem de capa do card">
                                <div class="card-body">
                            ...
                            <div class="card text-white bg-danger mb-3">
                                <img class="card-img-top" src="img/pz_08_170x170.png" alt="Imagem de capa do card">
                                <div class="card-body">
                                    <h5 class="card-title">Marguerita</h5>
                                    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae dolorem eius dicta aut et modi culpa consectetur, aliquid, maiores cum id. Dolor suscipit tempora laboriosam nam sit numquam dicta ea.</p>
                                    <p class="card-text text-white"><small class="text-white">Atualizados 3 minutos atrás</small></p>
                                </div>
                            </div>
                        </div>
                   </div>
